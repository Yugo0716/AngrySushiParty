...
public class BackGenerateBalancer : MonoBehaviour
{
    [SerializeField] GameObject generatorObjA;
    [SerializeField] GameObject generatorObjB;

    BackSushiGenerator sushiGeneratorA;
    BackSushiGenerator sushiGeneratorB;
    ...
    void Start()
    {
        sushiGeneratorA = generatorObjA.GetComponent<BackSushiGenerator>();
        sushiGeneratorB = generatorObjB.GetComponent<BackSushiGenerator>();
    }
